	...
	public static void main(String[] args) {
		...
		while (exit) {
			...
			case 9:
				...
				break;
			case 10:
				try (// implement Serializable transacptionRecord simple class object
						FileOutputStream fos = new FileOutputStream("./src/log/TransactionRecordFile.txt");
						ObjectOutputStream out = new ObjectOutputStream(fos)) {
					for (TransactionRecord rec : Transaction.records) {
						out.writeObject(rec.toString() + "\n_________________");
					}
					System.out.println("Log creater successfully!!!!!");
				} catch (Exception e) {
					System.err.println(e.getMessage());
				}
			default:
...
/*
 * hanuman val MYTHOLOGY
 * 
 * Computer Amarsir CPP
 * 
 * artoflove l BIOLOGY
 */
